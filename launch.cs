...
{
    public static IEnumerable<Launch> ReadLaunch(this IDbConnection dbConnection, string query)
    {
    ...
    public static IEnumerable<Launch3> ReadLaunch3(this IDbConnection dbConnection, string query)
    {
